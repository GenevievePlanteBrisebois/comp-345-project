...
Map::Map(int nodes)
{
	...
	borough[0] = new Borough(false, "StatenIsland", "");
	borough[1] = new Borough(false, "StatenIsland", "");
	...
	borough[8] = new Borough(false, "LowerManhattan", "");
	borough[9] = new Borough(false, "MidManhattan", "");
	borough[10] = new Borough(false, "UpperManhattan", "");
}
